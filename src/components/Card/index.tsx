...
import soilImage from '@/assets/home/SOILImg.jpg'
import farmImage from '@/assets/home/farm-enrolled.jpg'
        ...
        <Card className="relative bg-green-200 rounded-xl mx-4  mt-2 overflow-hidden h-[145px]">
            ...
            <div className="text-white p-4 h-full">
                ...
                <div className="absolute -bottom-1 -right-2 w-19 h-19 bg-white rounded-full flex items-center justify-center shadow-md">
                    <div
                        className="bg-green-900 p-3 rounded-full flex w-[53px] h-[53px] items-center justify-center"
                    >
...
export const FarmerRegisteredCard: React.FC<FarmerRegisteredCard> = ({ title, description, imageUrl }) => {
    return (
...
export const SoilTestReportCard: React.FC<FarmerRegisteredCard> = ({ title, description, imageUrl }) => {
    return (
        <Card className='flex justify-between'>
            <div className='p-4 pr-0'>
                <h5 className="font-semibold text-base">{title}</h5>
                <p
                    className={` mt-1 text-base font-normal text-green-700`}
                >
                    {description}
                </p>
            </div>
            ...
            <div className='relative width-full rounded-xl'>
                ...
                />
                <div className="absolute top-0 left-0 w-[100%] h-[100%]" style={{ background: 'linear-gradient(to left, rgba(255,255,255,0), rgba(255,255,255,1))' }} />
            </div>
...
export const ShareGrainProductionCard: React.FC<SharedGrainProductionProps> = ({ title, totalQuantity, data }) => {
    return (
        <Card>
...
export const FertilizerPestisedsCard: React.FC<FertilizerPestisedsCardProps> = ({ title, data }) => {
    return (
        <>
            <Card className='p-4'>
